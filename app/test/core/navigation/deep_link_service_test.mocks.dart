...
// in from_fed_to_chain_app/test/core/navigation/deep_link_service_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockContentService extends _i1.Mock implements _i4.ContentService {
  MockContentService() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i3.Future<_i7.AudioContent?> fetchContentById(
    String? id,
    String? language,
    String? category,
  ) =>
      (super.noSuchMethod(
        ...
        returnValue: _i3.Future<_i7.AudioContent?>.value(),
      ) as _i3.Future<_i7.AudioContent?>);

  @override
  _i3.Future<_i7.AudioContent?> getContentForAudioFile(
  ...
  @override
  _i3.Future<_i5.AudioFile?> getAudioFileById(String? contentId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getAudioFileById,
          [contentId],
        ),
        returnValue: _i3.Future<_i5.AudioFile?>.value(),
      ) as _i3.Future<_i5.AudioFile?>);

  @override
  _i3.Future<void> prefetchContent(List<_i5.AudioFile>? audioFiles) =>
      (super.noSuchMethod(
        Invocation.method(
          #prefetchContent,
          [audioFiles],
  ...
  @override
  _i3.Future<void> loadAllEpisodes() => (super.noSuchMethod(
        Invocation.method(
          #loadAllEpisodes,
          [],
        ),
  ...
  @override
  _i3.Future<void> loadEpisodesForLanguage(String? language) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<List<_i5.AudioFile>> searchEpisodes(String? query) =>
      (super.noSuchMethod(
        Invocation.method(
          #searchEpisodes,
          [query],
        ),
        returnValue: _i3.Future<List<_i5.AudioFile>>.value(<_i5.AudioFile>[]),
      ) as _i3.Future<List<_i5.AudioFile>>);
  ...
  @override
  _i3.Future<void> setEpisodeCompletion(
    String? episodeId,
    double? completion,
  ) =>
      (super.noSuchMethod(
...
class MockAudioPlayerService extends _i1.Mock
  ...
  @override
  _i10.AppPlaybackState get playbackState => (super.noSuchMethod(
        Invocation.getter(#playbackState),
        returnValue: _i10.AppPlaybackState.stopped,
      ) as _i10.AppPlaybackState);
  ...
  @override
  _i3.Future<void> playAudio(_i5.AudioFile? audioFile) => (super.noSuchMethod(
        Invocation.method(
          #playAudio,
          [audioFile],
        ),
  ...
  @override
  _i3.Future<void> skipToNextEpisode() => (super.noSuchMethod(
        Invocation.method(
          #skipToNextEpisode,
          [],
        ),
  ...
  @override
  _i3.Future<void> skipToPreviousEpisode() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<void> skipForward() => (super.noSuchMethod(
        Invocation.method(
          #skipForward,
          [],
        ),
  ...
  @override
  _i3.Future<void> skipBackward() => (super.noSuchMethod(
        Invocation.method(
          #skipBackward,
          [],
        ),
  ...
  @override
  _i3.Future<void> restorePlaybackPosition(_i5.AudioFile? audioFile) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<void> onEpisodeCompletedManually() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<void> play(_i5.AudioFile? audioFile) => (super.noSuchMethod(
        Invocation.method(
          #play,
          [audioFile],
        ),
  ...
  @override
  _i3.Future<void> skipToNext() => (super.noSuchMethod(
        Invocation.method(
          #skipToNext,
          [],
        ),
  ...
  @override
  _i3.Future<void> skipToPrevious() => (super.noSuchMethod(
        Invocation.method(
          #skipToPrevious,
          [],
        ),
  ...
  @override
  _i3.Future<void> seekForward() => (super.noSuchMethod(
        Invocation.method(
          #seekForward,
          [],
        ),
  ...
  @override
  _i3.Future<void> seekBackward() => (super.noSuchMethod(
        Invocation.method(
          #seekBackward,
          [],
        ),
  ...
  @override
  void setPlaybackStateForTesting(_i10.AppPlaybackState? state) =>
      super.noSuchMethod(
        Invocation.method(
