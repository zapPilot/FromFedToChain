...
/// Legacy service for managing audio content, playlists, and episode navigation
/// @deprecated Use ContentFacadeService instead for new code
@Deprecated('Use ContentFacadeService for better modular architecture')
class LegacyContentService extends ChangeNotifier {
  ...
  LegacyContentService({http.Client? httpClient})
  ...
  static Future<AudioContent?> getContentById(String contentId) async {
    ...
    final instance = LegacyContentService();
