...
export class CLI {
  static async showTranslationStatus() {
    ...
    files.forEach((file, index) => {
      ...
      const langData = file.data.languages[file.data.metadata.translation_status.source_language];
  ...
  static showHelp() {
    ...
    console.log('translate --target=<lang> - Translate all to specific language');
    console.log('translate-status          - Show translation status');
    console.log('tts                       - Process TTS for all pending content');
